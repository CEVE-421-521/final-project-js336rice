...
Only the wealthiest 10% of americsn have more than 111,000 USD in their bank accounts, so our high-savings individuals with more than 120k are doing fairly well, but still can't afford the "optimal" elevation.

```{julia}
LHSE_options = gen_finances(0.8, 120_000, house)
plot_LHSE_scenario(LHSE_options, "High Savings (120k), High Equity(80%)")
