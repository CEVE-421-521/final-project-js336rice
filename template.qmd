...
function annual_v_npv(finance)
    ...
    elevation_cost = elevation_cost(house, best_elevation)

    if finance.loan == 0 #out of pocket
        annual_cost = elevation_cost
    elseif finance.loan == 1  #taking out a loan
        annual_cost = annual_loan_cost(elevation_cost, finance.loan_rate, finance.loan_years)
    else #saving up 
        annual_cost = elevation_cost/finance.loan_years
    end
...
elevation_cost = elevation_cost(house, min)
