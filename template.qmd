...
finance_basic = let
    ...
    loan_years = 0
    loan_rate = 0.0
    paid_off_percent = 5.0
    amnt_paid_off = (paid_off_percent / 100) * house.value_usd  # Calculate amnt_paid_off
...
finance_basic = let  #Original finance, no loan, paying up-front 
    loan = 0 
    loan_years = 0
    loan_rate = 0.0 #note that rate here is in whole percents
    paid_off_percent=5.0  #This is also in whole percents
    amnt_paid_off=(paid_off_percent/100)*house.value_usd
    #print(amnt_paid_off)
    Finance(; loan=loan, 
    loan_years=loan_years, 
    loan_rate=loan_rate, 
...
for i in range(start=3, stop=9, length=4)
    #print(i)
    fin = Finance(; loan=1, loan_years=5, loan_rate=Int64(i))
