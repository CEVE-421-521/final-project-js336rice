...
We can validate the finance feature by obseving its impacts across the graphs we previously made for saving across several years, and taking out a loan.
...
For both of these graphs, the outputs are consistent with what we would expect if we took these actions:  NPV is lower, the actions we can take are limited by our finances, and the ideal elevation height is lowered.  When we take out a loan this is due to the upfront cost of elevating being higher due to the interest rate on the loan, and when we save, this is due partly becasue elevation costs increases over time with inflation, and partly becasue the benefits of elevating are somewhat diminished after a few years of potential (or real) flooding are behind us.
...
We'll present our results by looking at four scenarios: One where the homeowner has high equity and high savings, one where they have low equity and low savings, and 
